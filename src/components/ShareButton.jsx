...
function ShareButton({ username, avatar, inline = false }) {
  const handleShare = async () => {
    ...
    try {
      ...
      // leetcode wrapped {yearLabel} text centered at top - with colors
...
=======
      ...
      const textTotalWidth =
        leetWidth + codeWidth + spaceWidth + wrappedWidth + yearWidth;
>>>>>>> Stashed changes
...
>>>>>>> Stashed changes
      ...
      finalCanvas.toBlob(async (blob) => {
        const file = new File([blob], `leetcode-wrapped-${username}.png`, {
          type: "image/png",
        });
...
=======
            await navigator.share({
              files: [file],
              title: `leetcode wrapped ${yearLabel}`,
            });
>>>>>>> Stashed changes
            return;
          } catch (err) {}
